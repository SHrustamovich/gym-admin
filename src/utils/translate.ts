...
const uz: Trans = {
    ...
    logout: "Chiqish",
    add: "Yangi qo'shish",
    success: "Azo muvafaqqiyatli qo'shildi",
    ...
    paid: "To'langan",
    action: "Harakat",
    info: "Sotib olingan maxsulotlar haqida batafsil",
    pur: "Sotib olingan miqdor",
    close: "YOPISH",
    user: "Foydalanuvchi tasnifiI",
